...
export const GogFilterCreateResponse = z.union([z.object({ filter: GogFilter }), GogFilter]);
...
export const GogProfile = z.union([
  z.object({
    person: z
      .object({
...
export type GogProfileT = z.infer<typeof GogProfile>;

 ...
 * navigating the iframe. Half a fix on its own: asking for `_blank` only works
 * where the sandbox permits an auxiliary browsing context, which is why
 * `HtmlBodyFrame` carries `allow-popups` (#148).
 */

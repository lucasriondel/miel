 ...
 *
 * Triage only. Every other task keeps its default: none of them is what a first
 * sync needs, and a card of model choices before the user has seen a single
 * message is a worse first run than one choice.
 *

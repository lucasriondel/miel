...
export const FilterSelectionBar = ({
  ...
  <section
    ...
    className="sticky top-0 z-40 flex flex-wrap items-center gap-3 rounded-xl border border-gousse-line bg-gousse-panel/95 px-3 py-2 shadow-gousse-md backdrop-blur"
  >

...
/**
 * One entry per period, keyed by the vocabulary itself — a period added later
 * cannot reach this component without wording of its own. The "All" entry went
 * with the segment it belonged to (#151).
 */
const COPY: Record<RangeMode, { title: string; description: string }> = {
  week: {
  ...
  year: {
    title: "All caught up this year",
    description: "Nothing left to triage for the selected year.",
  },
};

export const AllCaughtUp = ({ mode }: Props) => {

 ...
 *
 * NOTE: fields with genuinely different chrome (the filters search box's leading
 * icon inset, the triage batch stepper's narrow numeric field) stay raw
 * <input> — routing them here would add a focus ring / change padding, which
 * the behavior contract forbids.
 */
